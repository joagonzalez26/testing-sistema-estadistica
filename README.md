...
- calculadora con casos negativos
...
- comparación entre testing manual y testing asistido por IA
- evidencias
...
- entender un sistema desde adentro
- probarlo manualmente con criterio QA
- documentar bugs y evidencias
- automatizar flujos importantes
- comparar frameworks
...
- Por eso, además de ser una práctica técnica, este repositorio representa una forma concreta de aplicar lo aprendido a un caso real.

- Quiero dejar como recordatorio que este proyecto puede servir para adentrarse al mundo del testing.
- En mi perfil se encuentra toda la información de contacto por otras dudas.

## Estado del proyecto

El proyecto quedó organizado en tres etapas completas:
